...
La implementación de ServerHandler define la *identidad del servidor*. Le dice al cliente (Llama Stack) cómo se llama el servidor (penalty-engine-mcp-rs), su versión y qué instrucciones generales debe seguir el agente al usarlo.
