...
En la barra lateral izquierda, accede a compatibility-engine>src>common/compatibility-engine.yaml. Este es el archivo en el que definiremos todo el servidor. 
