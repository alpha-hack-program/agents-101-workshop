...
----
cd
git clone --branch empty --single-branch git@github.com:alpha-hack-program/penalty-engine-mcp-rs.git
----
...
¡Hasta aquí el copiado! Deberías tener alrededor de 660 líneas de código en las que queda toda la lógica del servidor MCP. ¿Cuál será el siguiente paso? Crear una imagen con el código y desplegarla junto al resto de componentes de Llama Stack. ¡Continúa a la siguiente sección!
