...
Al hacerlo, seremos redirigidos a la página de Deployments, donde veremos los modelos que hemos desplegado. El modelo puede llegar a tardar 10 minutos en desplegarse. Sabrás que se ha desplegado correctamente cuando su status cambie a `Running`.
