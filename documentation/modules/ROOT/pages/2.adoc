...
Al entrar en la página del modelo, vemos información como detalles sobe su arquitectura y su fecha de lanzamiento. Si descendemos, veremos los resultados que ha obtenido en los benchmarks más populares. Si clicas en Performance Insights, verás los resultados obtenidos en los tests de velocidad realizados por Red Hat en diferentes configuraciones de GPUs.
...
[source,bash,subs="+macros,+attributes"]
----
Cuéntame cómo hacer una tortilla de patatas.
----

image::playground-answer.png[]

En la respuesta del modelo, se pueden ver dos procesos:
...
- Segundo la respuesta final que muestra al usuario.
