...
En el segundo paso, vamos a definir el **proyecto** con el nombre `llama-stack-demo-user<NOMBRE-USUARIO>`. En el **Hardware profile**, selecciona `nvidia`. Cuando esté listo, clica en `Next`.
...
Hemos terminado esta parte, vamos a pasar a la sección **3.Desarrollar el Servidor MCP**.
