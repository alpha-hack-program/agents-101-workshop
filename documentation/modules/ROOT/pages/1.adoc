...
Durante el taller, se te abrirán pestañas en tu navegador. Es importante que no las elimines para trabajar fácilmente entre ellas.

¡Clica en la *URL* para acceder al cluster! Luego introduce tu *usuario* y *contraseña*.
