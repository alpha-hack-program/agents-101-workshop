...
Vamos a rellenar el formulario de creación del workbench. En `name`, escribe {workbench}. Cuando lo tengamos listo, confirma al botón inferior izquierdo "Create workbench".
