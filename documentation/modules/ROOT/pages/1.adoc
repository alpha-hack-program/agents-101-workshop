...
Vamos a rellenar el formulario de creación del workbench como en la siguiente imagen. Recuerda que en `name`, tienes que escribir {workbench}. Cuando lo tengas listo, confirma al botón inferior izquierdo "Create workbench".
