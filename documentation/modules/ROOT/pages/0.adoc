...
El objetivo de este taller es desplegar un **asistente** para ayudar a los ciudadanos de un país ficticio, *Lysmark*. A través del chat, los usuarios podrán pedir información sobre la *leyes del país*. En este caso, nos centraremos en ofrecer información precisa sobre las *penalizaciones por retrasos* de envíos en empresas de paquetería. 
...
Para este taller, **no tienes que instalar nada en tu portátil**. Simplemente necesitas un navegador al que acceder a las URLs donde trabajarás. Dispondrás de acceso a un clúster de OpenShift que ya dispone de OpenShift AI y te moveras entre diferentes pestañas:
